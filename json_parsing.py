...
class Weather(colander.MappingSchema):
	...
	windGustKPH = colander.SchemaNode(colander.Decimal(), missing=colander.drop)
	pressureIn = colander.SchemaNode(colander.Decimal(), missing=colander.drop)
	pressureMb = colander.SchemaNode(colander.Decimal(), missing=colander.drop)
	relativeHumidity = colander.SchemaNode(colander.String(), missing=colander.drop)
	longitude = colander.SchemaNode(colander.Decimal(), missing=colander.drop)
	precipTodayMetric = colander.SchemaNode(colander.Int(), missing=colander.drop)
	windKPH = colander.SchemaNode(colander.Decimal(), missing=colander.drop)
	windDegrees =colander.SchemaNode(colander.Int(), missing=colander.drop)
	tempC = colander.SchemaNode(colander.Decimal(), missing=colander.drop)
